...
import tableDataDevelopment from 'variables/book/tableDataDevelopment';
import tableDataCheck from 'variables/book/tableDataCheck';
import CheckTable from 'components/admin/book/CheckTable';
import tableDataColumns from 'variables/book/tableDataColumns';
import tableDataComplex from 'variables/book/tableDataComplex';
import DevelopmentTable from 'components/admin/book/DevelopmentTable';
import ColumnsTable from 'components/admin/book/ColumnsTable';
import ComplexTable from 'components/admin/book/ComplexTable';
...
const Tables = () => {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="mt-5 grid h-full">
      <Card className="mb-4 grid grid-cols-2 gap-4 rounded-[20px] bg-white p-4">
